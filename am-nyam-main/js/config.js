/* ============================================================================
 * js/config.js — описание игры: двадцать миров, их волны, награды и особенности.
 *
 * Миры собраны в пять краёв по четыре мира. У каждого края свой вид, свои
...
(function () {
  ...
  function buildWaves(index) {
    var w = index + 1;                    // номер мира, 1…20
    var grow = index / 19;                // 0 в первом мире, 1 в двадцатом
  ...
  var list = WORLDS.map(function (w, i) {
    ...
    return {
      ...
      enemyHp: 1 + i * 0.18,
      enemySpeed: 1 + i * 0.02,
      enemyDamage: 1 + Math.floor(i / 7),     // +1 урона каждые семь миров
      candyMul: 1 + i * 0.12,
      dustMul: 1 + i * 0.10,
